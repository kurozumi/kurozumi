...
- **[Zenn](https://zenn.dev/kurozumi)** にてEC-CUBE・Symfonyの技術記事を執筆
...
| **システム移行・バージョンアップ** | EC-CUBE 3系→4系移行、マイナーバージョンアップ対応 |
| **決済・外部API連携** | 各種決済モジュール・物流システム・ERPとのAPI連携 |
...
- EC-CUBE 3系→4系へのバージョンアップ・移行
- 外部サービス（決済・物流・ERP等）との連携開発
...
EC-CUBE & Symfony expert based in Tokyo. 10+ years of experience in EC site development, plugin creation, and open-source contribution. Published 190+ plugins on the EC-CUBE Owners Store. Available for remote contract work nationwide.
