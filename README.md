...
| クライアント | 内容 |
|-------------|------|
| **伊藤忠商事** | EC-CUBEで構築したECシステムを部長へプレゼンテーション。大手商社の意思決定層への技術提案を経験 |
| **パナソニック** | EC-CUBEプラグインのカスタマイズ対応。大規模メーカーの要件に合わせた機能拡張を実施 |
| **アイリスオーヤマ** | EC-CUBEプラグインのカスタマイズ対応。EC運用実績豊富な企業のニーズに対応 |
...
| **パフォーマンス改善** | クエリ最適化・キャッシュ設計・レスポンス改善 |
| **マイナーバージョンアップ対応** | EC-CUBE 4系のマイナーバージョンアップ対応 |

### 技術スタック

- **バックエンド**: PHP 8.x / Symfony 6.x / EC-CUBE 4.x / Doctrine ORM
- **フロントエンド**: Twig / JavaScript / CSS
- **インフラ**: Docker / AWS / Linux
...
EC-CUBE & Symfony expert based in Tokyo. 10+ years of experience in EC site development, plugin creation, and open-source contribution. Published 190+ plugins on the EC-CUBE Owners Store. Past clients include Itochu Corporation, Panasonic, and Iris Ohyama. Available for remote contract work nationwide.
